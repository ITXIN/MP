...
struct SegmentStyle {
    ...
    /// 下面的滚动条的颜色
    var scrollLineColor = RGBA(220, G: 50, B: 55, A: 1)
    
    /// 遮盖的背景颜色
    var coverBackgroundColor = UIColor.lightText
    /// 遮盖圆角
    ...
    var selectedTitleColor = RGBA(220, G: 50, B: 55, A: 1)
//        UIColor(red: 255.0/255.0, green: 0.0/255.0, blue: 121/255.0, alpha: 1.0)
